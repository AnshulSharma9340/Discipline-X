...
export function Topbar() {
  ...
  return (
    <header className="h-16 border-b border-white/[0.06] bg-black/40 backdrop-blur-xl flex items-center px-6 gap-4 sticky top-0 z-20">
      ...
      <div className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-white/10 text-xs">
        <Zap className="w-3.5 h-3.5 text-violet-300" strokeWidth={2} />
